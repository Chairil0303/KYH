            ...
            <div>
                <div class="flex items-center gap-3 mb-5">
                    <img src="{{ asset('assets/icons/icons_kyh.png') }}" alt="KYH Logo"
                        class="h-24 w-auto object-contain drop-shadow-[0_0_10px_rgba(201,168,76,0.4)]">
                </div>
                ...
                <p class="text-white/55 text-sm leading-relaxed mb-6">
                    Mengambil alih stres Anda agar Anda bisa menikmati momen. Kami hadir untuk mewujudkan setiap detail
                    impian pernikahan dan acara Anda menjadi kenangan abadi.
                </p>

                {{-- Social Icons --}}
                <div class="flex items-center gap-3">
                    <a href="https://www.instagram.com/kyh.organizer" target="_blank" class="w-9 h-9 rounded-full border border-[#C9A84C]/40 flex items-center justify-center
                              text-[#C9A84C]/70 hover:text-[#C9A84C] hover:border-[#C9A84C] hover:bg-[#C9A84C]/10
                              transition-all duration-300" aria-label="Instagram KYH">
                    ...
                    <a href="https://wa.me/6285282918207" target="_blank" class="w-9 h-9 rounded-full border border-[#C9A84C]/40 flex items-center justify-center
                              text-[#C9A84C]/70 hover:text-[#C9A84C] hover:border-[#C9A84C] hover:bg-[#C9A84C]/10
                              transition-all duration-300" aria-label="WhatsApp KYH">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    @foreach ($footerLinks as $link)
                        <li>
                            <a href="{{ $link['href'] }}"
                                ...
                                <span
                                    class="w-4 h-[1px] bg-[#C9A84C]/0 group-hover:bg-[#C9A84C] transition-all duration-300"></span>
                                {{ $link['label'] }}
                            </a>
                        </li>
                    @endforeach
            ...
            <div>
                ...
                <ul class="space-y-4 mt-4">
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        <a href="https://wa.me/6285282918207" target="_blank"

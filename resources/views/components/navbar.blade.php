...
>
        ...
        <div class="flex items-center justify-between h-20">
            ...
            <a href="{{ route('home') }}" class="flex items-center gap-3 flex-shrink-0">
                <img
                    ...
                    alt="KYH Logo"
                    class="h-12 w-auto object-contain drop-shadow-[0_0_8px_rgba(201,168,76,0.5)]"
                >
                <span
                    :class="scrolled ? 'text-[#C9A84C]' : 'text-[#C9A84C]'"
                    class="font-playfair text-2xl font-bold tracking-widest hidden sm:block"
                    ...
                    <li>
                        <a
                            ...
                            :class="activeSection === '{{ $link['section'] }}'
                                ...
                                : 'text-white/80 hover:text-[#C9A84C] after:w-0 hover:after:w-full'"
                            class="relative text-sm font-medium tracking-wider uppercase transition-colors duration-300
            ...
            <div class="hidden md:block">
                <a
                    href="#kontak"
                    class="inline-flex items-center gap-2 px-6 py-2.5 rounded-full text-sm font-semibold tracking-wider uppercase
            ...
            >
                ...
                <svg x-show="mobileOpen" class="w-6 h-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="display:none;">
    ...
    <div
        ...
        class="md:hidden bg-[#0D0D0D]/97 backdrop-blur-md border-t border-[#C9A84C]/20"
        style="display: none;"
    >
        <div class="px-4 py-6 space-y-1">
            @foreach ($navLinks as $link)
                <a
                    ...
                    class="block px-4 py-3 text-sm font-medium tracking-wider uppercase text-white/80
            ...
            <div class="pt-4 pb-2">
                <a
                    href="#kontak"
                    @click="mobileOpen = false"
                    class="block w-full text-center py-3 rounded-full font-semibold tracking-wider uppercase
